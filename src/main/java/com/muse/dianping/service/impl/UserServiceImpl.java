...
import static com.muse.dianping.utils.SystemConstants.USER_NICK_NAME_PREFIX;
...
//        session.setAttribute("code",code);
    ...
    public Result login(LoginFormDTO loginForm, HttpSession session) {
        ...
        //2.校验验证码,(这里获得redis中的code值的时候应该使用产量去获得)
        ...
        Map<String, Object> userMap = BeanUtil.beanToMap(userDTO,new HashMap<>(),CopyOptions
                ...
                .setFieldValueEditor((fileldName,fieldValue)->fieldValue.toString()));
        //7.3存储'
    ...
    //ession.setAttribute("user", BeanUtil.copyProperties(user, UserDTO.class));
